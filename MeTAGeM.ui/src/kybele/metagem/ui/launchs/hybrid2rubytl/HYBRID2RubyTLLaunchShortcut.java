...
public class HYBRID2RubyTLLaunchShortcut implements ILaunchShortcut {
	...
	protected ILaunchConfigurationType getConfigurationType() {
		...
		return getLaunchManager().getLaunchConfigurationType(HYBRID2RUBYTLConstants.MODEL_CONFIGTYPE_ID);
	}
	...
	protected ILaunchConfiguration findLaunchConfiguration(String pathIN, ILaunchConfigurationType configType) {
		...
		try {
			...
			for (int i = 0; i < configs.length; i++) {
				...
				if (config.getAttribute(HYBRID2RUBYTLConstants.ATTR_TRANSFORMATION_IN, "").equals(pathIN)) { 
