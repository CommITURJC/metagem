...
/**
 * This is the item provider adapter for a {@link hybrid.RightPattern} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RightPatternItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_RightPattern_operation_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_RightPattern_operation_feature", "_UI_RightPattern_type"),
				 HybridPackage.Literals.RIGHT_PATTERN__OPERATION,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addConcreteValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_RightPattern_concreteValue_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_RightPattern_concreteValue_feature", "_UI_RightPattern_type"),
				 HybridPackage.Literals.RIGHT_PATTERN__CONCRETE_VALUE,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(HybridPackage.Literals.RIGHT_PATTERN__SOURCE);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/RightPattern"));
	}
	...
	public String getText(Object object) {
		String label = ((RightPattern)object).getConcreteValue();
		return label == null || label.length() == 0 ?
			getString("_UI_RightPattern_type") :
			getString("_UI_RightPattern_type") + " " + label;
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(HybridPackage.Literals.RIGHT_PATTERN__SOURCE,
