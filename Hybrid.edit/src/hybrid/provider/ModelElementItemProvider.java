...
/**
 * This is the item provider adapter for a {@link hybrid.ModelElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ModelElementItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ModelComponent_ref_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ModelComponent_ref_feature", "_UI_ModelComponent_type"),
				 HybridPackage.Literals.MODEL_COMPONENT__REF,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(HybridPackage.Literals.MODEL_ELEMENT__CHILD_ELEMENTS);
			childrenFeatures.add(HybridPackage.Literals.MODEL_ELEMENT__FEATURES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(HybridPackage.Literals.MODEL_ELEMENT__CHILD_ELEMENTS,
				 HybridFactory.eINSTANCE.createModelElement()));

		newChildDescriptors.add
			(createChildParameter
				(HybridPackage.Literals.MODEL_ELEMENT__FEATURES,
				 HybridFactory.eINSTANCE.createModelFeature()));
	}
