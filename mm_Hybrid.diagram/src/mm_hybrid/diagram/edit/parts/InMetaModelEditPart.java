 ...
 * @generated
 */
public class InMetaModelEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public InMetaModelEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new mm_hybrid.diagram.edit.policies.InMetaModelItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		InMetaModelFigure figure = new InMetaModelFigure();
	 ...
	 * @generated
	 */
	public InMetaModelFigure getPrimaryShape() {
		return (InMetaModelFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof mm_hybrid.diagram.edit.parts.InMetaModelName_mmEditPart) {
			((mm_hybrid.diagram.edit.parts.InMetaModelName_mmEditPart) childEditPart)
	 ...
	 * @generated
	 */
	public class InMetaModelFigure extends RoundedRectangle {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureInMetaModelLabelFigure;
		...
		private void createContents() {
			...
			WrappingLabel inMetaModelLabel0 = new WrappingLabel();
			inMetaModelLabel0.setAlignment(PositionConstants.CENTER);
			inMetaModelLabel0.setText("<<Input MetaModel>>");

			inMetaModelLabel0.setFont(INMETAMODELLABEL0_FONT);

			this.add(inMetaModelLabel0);

			fFigureInMetaModelLabelFigure = new WrappingLabel();
			fFigureInMetaModelLabelFigure
					.setAlignment(PositionConstants.CENTER);
			fFigureInMetaModelLabelFigure.setText("<...>");
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureInMetaModelLabelFigure() {
	 ...
	 * @generated
	 */
	static final Color THIS_FORE = new Color(null, 0, 0, 128);
