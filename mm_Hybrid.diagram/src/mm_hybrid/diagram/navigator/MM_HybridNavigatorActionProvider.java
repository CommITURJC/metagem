 ...
 * @generated
 */
public class MM_HybridNavigatorActionProvider extends CommonActionProvider {
	...
	private class OpenDiagramAction extends Action {
		...
		public OpenDiagramAction(ICommonViewerWorkbenchSite viewerSite) {
			super(
					mm_hybrid.diagram.part.Messages.NavigatorActionProvider_OpenDiagramActionName);
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof mm_hybrid.diagram.navigator.MM_HybridNavigatorItem) {
					selectedElement = ((mm_hybrid.diagram.navigator.MM_HybridNavigatorItem) selectedElement)
							.getView();
