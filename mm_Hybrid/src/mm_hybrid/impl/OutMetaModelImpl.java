...
public class OutMetaModelImpl extends EObjectImpl implements OutMetaModel {
	...
	public Module getModule() {
		if (eContainerFeatureID != MM_HybridPackage.OUT_META_MODEL__MODULE)
			return null;
	...
	public NotificationChain basicSetModule(Module newModule,
		...
		msgs = eBasicSetContainer((InternalEObject) newModule,
				MM_HybridPackage.OUT_META_MODEL__MODULE, msgs);
		return msgs;
	}
	...
	public void setModule(Module newModule) {
		if (newModule != eInternalContainer()
				|| (eContainerFeatureID != MM_HybridPackage.OUT_META_MODEL__MODULE && newModule != null)) {
			...
			if (newModule != null)
				msgs = ((InternalEObject) newModule).eInverseAdd(this,
						MM_HybridPackage.MODULE__OUT_MM, Module.class, msgs);
			msgs = basicSetModule(newModule, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					MM_HybridPackage.OUT_META_MODEL__MODULE, newModule,
					newModule));
	}
