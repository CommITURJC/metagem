...
public class ElementIncludedImpl extends EObjectImpl implements ElementIncluded {
	...
	public void setTypeAttribute(TypeAtribute newTypeAttribute) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MM_HybridPackage.ELEMENT_INCLUDED__TYPE_ATTRIBUTE, oldTypeAttribute, typeAttribute));
	}
	...
	public void setTypeElement(TypeElem newTypeElement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MM_HybridPackage.ELEMENT_INCLUDED__TYPE_ELEMENT, oldTypeElement, typeElement));
	}
	...
	public NotificationChain basicSetRight(RightPattern newRight,
		...
		right = newRight;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MM_HybridPackage.ELEMENT_INCLUDED__RIGHT, oldRight, newRight);
	...
	public void setRight(RightPattern newRight) {
		if (newRight != right) {
			...
			if (right != null)
				msgs = ((InternalEObject)right).eInverseRemove(this, MM_HybridPackage.RIGHT_PATTERN__ELEMENT_INCLUDED, RightPattern.class, msgs);
			if (newRight != null)
				msgs = ((InternalEObject)newRight).eInverseAdd(this, MM_HybridPackage.RIGHT_PATTERN__ELEMENT_INCLUDED, RightPattern.class, msgs);
			msgs = basicSetRight(newRight, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MM_HybridPackage.ELEMENT_INCLUDED__RIGHT, newRight, newRight));
	}
	...
	public NotificationChain basicSetLeft(LeftPattern newLeft,
		...
		left = newLeft;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MM_HybridPackage.ELEMENT_INCLUDED__LEFT, oldLeft, newLeft);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setLeft(LeftPattern newLeft) {
		if (newLeft != left) {
			NotificationChain msgs = null;
			if (left != null)
				msgs = ((InternalEObject)left).eInverseRemove(this, MM_HybridPackage.LEFT_PATTERN__ELEMENT_INCLUDED, LeftPattern.class, msgs);
			if (newLeft != null)
				msgs = ((InternalEObject)newLeft).eInverseAdd(this, MM_HybridPackage.LEFT_PATTERN__ELEMENT_INCLUDED, LeftPattern.class, msgs);
			msgs = basicSetLeft(newLeft, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MM_HybridPackage.ELEMENT_INCLUDED__LEFT, newLeft, newLeft));
	}
	...
	public TargetElementRule getTargetElement() {
		if (eContainerFeatureID() != MM_HybridPackage.ELEMENT_INCLUDED__TARGET_ELEMENT) return null;
	...
	public NotificationChain basicSetTargetElement(
		...
		msgs = eBasicSetContainer((InternalEObject)newTargetElement, MM_HybridPackage.ELEMENT_INCLUDED__TARGET_ELEMENT, msgs);
		return msgs;
	}
	...
	public void setTargetElement(TargetElementRule newTargetElement) {
		if (newTargetElement != eInternalContainer() || (eContainerFeatureID() != MM_HybridPackage.ELEMENT_INCLUDED__TARGET_ELEMENT && newTargetElement != null)) {
			...
			if (newTargetElement != null)
				msgs = ((InternalEObject)newTargetElement).eInverseAdd(this, MM_HybridPackage.TARGET_ELEMENT_RULE__INCLUDED, TargetElementRule.class, msgs);
			msgs = basicSetTargetElement(newTargetElement, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MM_HybridPackage.ELEMENT_INCLUDED__TARGET_ELEMENT, newTargetElement, newTargetElement));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd,
		...
		switch (featureID) {
			case MM_HybridPackage.ELEMENT_INCLUDED__RIGHT:
				if (right != null)
					msgs = ((InternalEObject)right).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MM_HybridPackage.ELEMENT_INCLUDED__RIGHT, null, msgs);
				return basicSetRight((RightPattern)otherEnd, msgs);
			case MM_HybridPackage.ELEMENT_INCLUDED__LEFT:
				if (left != null)
					msgs = ((InternalEObject)left).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MM_HybridPackage.ELEMENT_INCLUDED__LEFT, null, msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(
		...
		switch (eContainerFeatureID()) {
			case MM_HybridPackage.ELEMENT_INCLUDED__TARGET_ELEMENT:
				return eInternalContainer().eInverseRemove(this, MM_HybridPackage.TARGET_ELEMENT_RULE__INCLUDED, TargetElementRule.class, msgs);
		}
