		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Element_name_element_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Element_name_element_feature", "_UI_Element_type"),
				 MM_HybridPackage.Literals.ELEMENT__NAME_ELEMENT,
				 true,
				 false,
				 false,
	...
	protected void addOperationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Element_operation_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Element_operation_feature", "_UI_Element_type"),
				 MM_HybridPackage.Literals.ELEMENT__OPERATION,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addIsReferedPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Element_isRefered_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Element_isRefered_feature", "_UI_Element_type"),
				 MM_HybridPackage.Literals.ELEMENT__IS_REFERED,
				 true,
				 false,
				 true,
				 null,
