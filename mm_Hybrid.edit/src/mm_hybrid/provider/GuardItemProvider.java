		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Guard_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Guard_value_feature", "_UI_Guard_type"),
				 MM_HybridPackage.Literals.GUARD__VALUE,
				 true,
				 false,
				 false,
