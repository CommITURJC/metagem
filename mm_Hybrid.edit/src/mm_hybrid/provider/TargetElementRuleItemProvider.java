...
public class TargetElementRuleItemProvider extends ElementItemProvider
	...
	protected void addMetamodelPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getResourceLocator(),
						getString("_UI_TargetElementRule_metamodel_feature"), //$NON-NLS-1$
						getString(
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(MM_HybridPackage.Literals.TARGET_ELEMENT_RULE__INCLUDED);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage(
				"full/obj16/TargetElementRule")); //$NON-NLS-1$
	}
