...
public class InMetaModelItemProvider extends ItemProviderAdapter implements
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_InMetaModel_name_mm_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_InMetaModel_name_mm_feature", "_UI_InMetaModel_type"),
				 MM_HybridPackage.Literals.IN_META_MODEL__NAME_MM,
				 true,
				 false,
				 false,
	...
	protected void addType_mmPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_InMetaModel_type_mm_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_InMetaModel_type_mm_feature", "_UI_InMetaModel_type"),
				 MM_HybridPackage.Literals.IN_META_MODEL__TYPE_MM,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addElementsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_InMetaModel_elements_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_InMetaModel_elements_feature", "_UI_InMetaModel_type"),
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/InMetaModel"));
	}
