...
/**
 * This is the item provider adapter for a {@link mm_hybrid.OutMetaModel} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OutMetaModelItemProvider extends ItemProviderAdapter implements
	 ...
	 * @generated
	 */
	public OutMetaModelItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_OutMetaModel_name_mm_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_OutMetaModel_name_mm_feature", "_UI_OutMetaModel_type"),
	...
	protected void addType_mmPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_OutMetaModel_type_mm_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_OutMetaModel_type_mm_feature", "_UI_OutMetaModel_type"),
	...
	protected void addElementsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_OutMetaModel_elements_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_OutMetaModel_elements_feature", "_UI_OutMetaModel_type"),
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/OutMetaModel"));
	}
