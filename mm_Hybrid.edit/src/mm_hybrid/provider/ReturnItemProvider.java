		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Return_element_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Return_element_feature", "_UI_Return_type"),
				 MM_HybridPackage.Literals.RETURN__ELEMENT,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MM_HybridPackage.Literals.RETURN__DATATYPE,
				 true,
				 false,
				 false,
