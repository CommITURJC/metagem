...
public class SourceElementRuleItemProvider extends ElementItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SourceElementRule_metamodel_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SourceElementRule_metamodel_feature", "_UI_SourceElementRule_type"),
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MM_HybridPackage.Literals.SOURCE_ELEMENT_RULE__GUARD);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SourceElementRule"));
	}
