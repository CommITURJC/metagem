...
/**
 * This is the item provider adapter for a {@link RubyTL.Mapping} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MappingItemProvider extends ItemProviderAdapter implements
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(RubyTLPackage.Literals.MAPPING__BINDINGS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Mapping.class)) {
			case RubyTLPackage.MAPPING__BINDINGS:
	...
	protected void collectNewChildDescriptors(
		...
		newChildDescriptors.add
			(createChildParameter
				(RubyTLPackage.Literals.MAPPING__BINDINGS,
				 RubyTLFactory.eINSTANCE.createBinding()));
	}
