...
/**
 * This is the item provider adapter for a {@link RubyTL.NamedElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RubyTLPackage.Literals.NAMED_ELEMENT__NAME,
				 true,
				 false,
				 false,
	...
	protected void addUriPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_NamedElement_uri_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_NamedElement_uri_feature", "_UI_NamedElement_type"),
				 RubyTLPackage.Literals.NAMED_ELEMENT__URI,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
