 ...
 * @generated
 */
public class MM_HybridDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public MM_HybridDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof mm_hybrid.diagram.navigator.MM_HybridDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier
							.getChildren(((mm_hybrid.diagram.navigator.MM_HybridDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result
						.add(new mm_hybrid.diagram.navigator.MM_HybridDomainNavigatorItem(
