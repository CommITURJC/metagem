 ...
 * @generated
 */
public class OutMetaModelViewFactory extends AbstractShapeViewFactory {
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = mm_hybrid.diagram.part.MM_HybridVisualIDRegistry
					.getType(mm_hybrid.diagram.edit.parts.OutMetaModelEditPart.VISUAL_ID);
		...
		if (!mm_hybrid.diagram.edit.parts.ModuleEditPart.MODEL_ID
			...
			shortcutAnnotation
					.getDetails()
					.put(
							"modelID", mm_hybrid.diagram.edit.parts.ModuleEditPart.MODEL_ID); //$NON-NLS-1$
		...
		getViewService()
				.createNode(
						...
						view,
						mm_hybrid.diagram.part.MM_HybridVisualIDRegistry
								.getType(mm_hybrid.diagram.edit.parts.OutMetaModelType_mmEditPart.VISUAL_ID),
						ViewUtil.APPEND, true, getPreferencesHint());
	}
}
