...
public class MM_HybridActionBarContributor extends
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("mm_hybrid-settings")); //$NON-NLS-1$
		toolBarManager.add(new Separator("mm_hybrid-additions")); //$NON-NLS-1$
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(
				MM_HybridEditorPlugin.INSTANCE
						.getString("_UI_MM_HybridEditor_menu"), "mm_hybridMenuID"); //$NON-NLS-1$ //$NON-NLS-2$
		...
		//
		createChildMenuManager = new MenuManager(MM_HybridEditorPlugin.INSTANCE
	...
	public void menuAboutToShow(IMenuManager menuManager) {
		...
		submenuManager = new MenuManager(MM_HybridEditorPlugin.INSTANCE
				.getString("_UI_CreateChild_menu_item")); //$NON-NLS-1$
