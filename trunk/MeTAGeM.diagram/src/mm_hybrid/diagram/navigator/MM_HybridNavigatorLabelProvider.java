...
public class MM_HybridNavigatorLabelProvider extends LabelProvider implements
	...
	public Image getImage(View view) {
		...
		case mm_hybrid.diagram.edit.parts.ConditionEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Node?http:///MM_Hybrid.ecore?Condition", mm_hybrid.diagram.providers.MM_HybridElementTypes.Condition_3003); //$NON-NLS-1$
		case mm_hybrid.diagram.edit.parts.TargetElementRuleEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Node?http:///MM_Hybrid.ecore?TargetElementRule", mm_hybrid.diagram.providers.MM_HybridElementTypes.TargetElementRule_3002); //$NON-NLS-1$
		}
	...
	public String getText(View view) {
		...
		case mm_hybrid.diagram.edit.parts.TargetElementRuleEditPart.VISUAL_ID:
			return getTargetElementRule_3002Text(view);
		}
	 ...
	 * @generated
	 */
	private String getTargetElementRule_3002Text(View view) {
		IAdaptable hintAdapter = new mm_hybrid.diagram.providers.MM_HybridParserProvider.HintAdapter(
				mm_hybrid.diagram.providers.MM_HybridElementTypes.TargetElementRule_3002,
				(view.getElement() != null ? view.getElement() : view),
				mm_hybrid.diagram.part.MM_HybridVisualIDRegistry
