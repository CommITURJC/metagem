...
public class MM_HybridPaletteFactory {
	...
	private ToolEntry createTargetElementRule3CreationTool() {
		...
		entry
				.setSmallIcon(mm_hybrid.diagram.providers.MM_HybridElementTypes
						.getImageDescriptor(mm_hybrid.diagram.providers.MM_HybridElementTypes.TargetElementRule_3002));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createCondition4CreationTool() {
		...
		entry
				.setSmallIcon(mm_hybrid.diagram.providers.MM_HybridElementTypes
						.getImageDescriptor(mm_hybrid.diagram.providers.MM_HybridElementTypes.Condition_3003));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
