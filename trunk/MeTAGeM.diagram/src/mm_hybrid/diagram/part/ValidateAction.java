...
public class ValidateAction extends Action {
	...
	public ValidateAction(IWorkbenchPartDescriptor workbenchPartDescriptor) {
		...
		setText(mm_hybrid.diagram.part.Messages.ValidateActionMessage);
	...
	public static void runValidation(View view) {
		try {
			if (mm_hybrid.diagram.part.MM_HybridDiagramEditorUtil
	...
	public static void runValidation(DiagramEditPart diagramEditPart, View view) {
		...
		mm_hybrid.diagram.providers.MM_HybridValidationProvider
	...
	private static void validate(DiagramEditPart diagramEditPart, View view) {
		...
		if (target != null) {
			mm_hybrid.diagram.providers.MM_HybridMarkerNavigationProvider
	...
	private static void createMarkers(IFile target, IStatus validationStatus,
		...
		mm_hybrid.diagram.part.MM_HybridDiagramEditorUtil.LazyElement2ViewMap element2ViewMap = new mm_hybrid.diagram.part.MM_HybridDiagramEditorUtil.LazyElement2ViewMap(
				diagramEditPart.getDiagramView(), collectTargetElements(
						rootStatus, new HashSet(), allStatuses));
		for (Iterator it = allStatuses.iterator(); it.hasNext();) {
			IConstraintStatus nextStatus = (IConstraintStatus) it.next();
			View view = mm_hybrid.diagram.part.MM_HybridDiagramEditorUtil
