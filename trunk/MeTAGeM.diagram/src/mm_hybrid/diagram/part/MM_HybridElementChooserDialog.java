 ...
 * @generated
 */
public class MM_HybridElementChooserDialog extends Dialog {
	 ...
	 * @generated
	 */
	public MM_HybridElementChooserDialog(Shell parentShell, View view) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		getShell()
				.setText(
						mm_hybrid.diagram.part.Messages.MM_HybridElementChooserDialog_SelectModelElementTitle);
	...
	private boolean isValidModelFile(IFile file) {
		...
		return "mm_hybrid".equals(fileExtension); //$NON-NLS-1$
	}
