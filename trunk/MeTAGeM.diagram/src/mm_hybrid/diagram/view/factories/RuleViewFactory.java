 ...
 * @generated
 */
public class RuleViewFactory extends AbstractShapeViewFactory {
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = mm_hybrid.diagram.part.MM_HybridVisualIDRegistry
					.getType(mm_hybrid.diagram.edit.parts.RuleEditPart.VISUAL_ID);
		...
		getViewService()
				.createNode(
						...
						view,
						mm_hybrid.diagram.part.MM_HybridVisualIDRegistry
								.getType(mm_hybrid.diagram.edit.parts.RuleIsAbstractIsMainEditPart.VISUAL_ID),
						ViewUtil.APPEND, true, getPreferencesHint());
		getViewService()
				.createNode(
						eObjectAdapter,
