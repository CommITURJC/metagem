...
/**
 * This is the item provider adapter for a {@link ETL.Element} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Element_className_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Element_className_feature", "_UI_Element_type"),
				 ETLPackage.Literals.ELEMENT__CLASS_NAME,
				 true,
				 false,
				 false,
	...
	protected void addMetamodelPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Element_metamodel_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Element_metamodel_feature", "_UI_Element_type"),
				 ETLPackage.Literals.ELEMENT__METAMODEL,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
