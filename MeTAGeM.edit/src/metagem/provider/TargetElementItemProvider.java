...
/**
 * This is the item provider adapter for a {@link metagem.TargetElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TargetElementItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MetagemPackage.Literals.TARGET_ELEMENT__ZERO_TO_ONE);
			childrenFeatures.add(MetagemPackage.Literals.TARGET_ELEMENT__ONE_TO_ONE);
			childrenFeatures.add(MetagemPackage.Literals.TARGET_ELEMENT__MANY_TO_ONE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MetagemPackage.Literals.TARGET_ELEMENT__ZERO_TO_ONE,
				 MetagemFactory.eINSTANCE.createZeroToOne()));

		newChildDescriptors.add
			(createChildParameter
				(MetagemPackage.Literals.TARGET_ELEMENT__ONE_TO_ONE,
				 MetagemFactory.eINSTANCE.createOneToOne()));

		newChildDescriptors.add
			(createChildParameter
				(MetagemPackage.Literals.TARGET_ELEMENT__MANY_TO_ONE,
