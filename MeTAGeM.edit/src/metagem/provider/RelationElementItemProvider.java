...
public class RelationElementItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addModelComponentPropertyDescriptor(object);
		}
		return itemPropertyDescriptors;
	}

	/**
	 * This adds a property descriptor for the Model Component feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addModelComponentPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_RelationElement_modelComponent_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_RelationElement_modelComponent_feature", "_UI_RelationElement_type"),
				 MetagemPackage.Literals.RELATION_ELEMENT__MODEL_COMPONENT,
				 true,
				 false,
				 true,
				 null,
