...
/**
 * This is the item provider adapter for a {@link metagem.ManyToMany} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ManyToManyItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MetagemPackage.Literals.MANY_TO_MANY__TARGET);
			childrenFeatures.add(MetagemPackage.Literals.MANY_TO_MANY__SOURCE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MetagemPackage.Literals.MANY_TO_MANY__TARGET,
				 MetagemFactory.eINSTANCE.createTargetElement()));

		newChildDescriptors.add
			(createChildParameter
				(MetagemPackage.Literals.MANY_TO_MANY__SOURCE,
