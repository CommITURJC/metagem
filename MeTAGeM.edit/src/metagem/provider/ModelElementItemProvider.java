		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ModelElement_ownedElement_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ModelElement_ownedElement_feature", "_UI_ModelElement_type"),
				 MetagemPackage.Literals.MODEL_ELEMENT__OWNED_ELEMENT,
				 true,
				 false,
				 true,
				 null,
