...
/**
 * This is the item provider adapter for a {@link metagem.ManyToOne} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ManyToOneItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MetagemPackage.Literals.MANY_TO_ONE__TARGET);
			childrenFeatures.add(MetagemPackage.Literals.MANY_TO_ONE__SOURCE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MetagemPackage.Literals.MANY_TO_ONE__TARGET,
				 MetagemFactory.eINSTANCE.createTargetElement()));

		newChildDescriptors.add
			(createChildParameter
				(MetagemPackage.Literals.MANY_TO_ONE__SOURCE,
