 ...
 * <ul>
 *   <li>{@link hybrid.impl.ReturnImpl#getDatatype <em>Datatype</em>}</li>
 *   <li>{@link hybrid.impl.ReturnImpl#getComponent <em>Component</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ReturnImpl extends EObjectImpl implements Return {
	...
	protected EClass eStaticClass() {
		return HybridPackage.Literals.RETURN;
	}
	...
	public void setDatatype(Datatype newDatatype) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HybridPackage.RETURN__DATATYPE, oldDatatype, datatype));
	}
