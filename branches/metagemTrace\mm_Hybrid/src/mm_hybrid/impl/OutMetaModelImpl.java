 ...
 *   <li>{@link mm_hybrid.impl.OutMetaModelImpl#getModule <em>Module</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OutMetaModelImpl extends EObjectImpl implements OutMetaModel {
	...
	public void setName_mm(String newName_mm) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MM_HybridPackage.OUT_META_MODEL__NAME_MM, oldName_mm, name_mm));
	}
	...
	public void setType_mm(String newType_mm) {
		...
		type_mm = newType_mm;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MM_HybridPackage.OUT_META_MODEL__TYPE_MM, oldType_mm, type_mm));
	}
	...
	public EList<TargetElementRule> getElements() {
		if (elements == null) {
			elements = new EObjectWithInverseResolvingEList<TargetElementRule>(TargetElementRule.class, this, MM_HybridPackage.OUT_META_MODEL__ELEMENTS, MM_HybridPackage.TARGET_ELEMENT_RULE__METAMODEL);
		}
		return elements;
	}
	...
	public Module getModule() {
		if (eContainerFeatureID() != MM_HybridPackage.OUT_META_MODEL__MODULE) return null;
	...
	public NotificationChain basicSetModule(Module newModule,
		...
		msgs = eBasicSetContainer((InternalEObject)newModule, MM_HybridPackage.OUT_META_MODEL__MODULE, msgs);
		return msgs;
	}
	...
	public void setModule(Module newModule) {
		if (newModule != eInternalContainer() || (eContainerFeatureID() != MM_HybridPackage.OUT_META_MODEL__MODULE && newModule != null)) {
			...
			if (newModule != null)
				msgs = ((InternalEObject)newModule).eInverseAdd(this, MM_HybridPackage.MODULE__OUT_MM, Module.class, msgs);
			msgs = basicSetModule(newModule, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MM_HybridPackage.OUT_META_MODEL__MODULE, newModule, newModule));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd,
		...
		switch (featureID) {
			...
			case MM_HybridPackage.OUT_META_MODEL__MODULE:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(
		...
		switch (eContainerFeatureID()) {
			case MM_HybridPackage.OUT_META_MODEL__MODULE:
				return eInternalContainer().eInverseRemove(this, MM_HybridPackage.MODULE__OUT_MM, Module.class, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case MM_HybridPackage.OUT_META_MODEL__ELEMENTS:
				getElements().clear();
				getElements().addAll((Collection<? extends TargetElementRule>)newValue);
				return;
			case MM_HybridPackage.OUT_META_MODEL__MODULE:
