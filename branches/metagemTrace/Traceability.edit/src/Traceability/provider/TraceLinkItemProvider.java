...
/**
 * This is the item provider adapter for a {@link Traceability.TraceLink} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TraceLink_operation_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TraceLink_operation_feature", "_UI_TraceLink_type"),
				 TraceabilityPackage.Literals.TRACE_LINK__OPERATION,
				 true,
				 false,
				 false,
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TraceabilityPackage.Literals.TRACE_LINK__SOURCE,
				 TraceabilityFactory.eINSTANCE.createSourceElement()));
