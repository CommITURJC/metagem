...
public class TraceabilitySwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case TraceabilityPackage.SOURCE_MODEL: {
			...
			case TraceabilityPackage.TARGET_MODEL: {
			...
			case TraceabilityPackage.SOURCE_ELEMENT: {
			...
			case TraceabilityPackage.TARGET_ELEMENT: {
