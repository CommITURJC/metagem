 ...
 * <ul>
 *   <li>{@link metagem.impl.TransformationElementImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class TransformationElementImpl extends EObjectImpl implements TransformationElement {
	...
	protected EClass eStaticClass() {
		return MetagemPackage.Literals.TRANSFORMATION_ELEMENT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MetagemPackage.TRANSFORMATION_ELEMENT__NAME, oldName, name));
	}
