...
public class RightPatternItemProvider extends ItemProviderAdapter implements
	...
	protected void addName_patternPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_RightPattern_name_pattern_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_RightPattern_name_pattern_feature", "_UI_RightPattern_type"),
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MM_HybridPackage.Literals.RIGHT_PATTERN__SOURCE_ELEMENT);
		}
