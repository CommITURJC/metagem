...
public class MM_HybridItemProviderAdapterFactory extends
	...
	public Adapter createSourceElementRuleAdapter() {
		if (sourceElementRuleItemProvider == null) {
			sourceElementRuleItemProvider = new SourceElementRuleItemProvider(this);
		}
	...
	public Adapter createTargetElementRuleAdapter() {
		if (targetElementRuleItemProvider == null) {
			targetElementRuleItemProvider = new TargetElementRuleItemProvider(this);
		}
	...
	public void dispose() {
		...
		if (inMetaModelItemProvider != null) inMetaModelItemProvider.dispose();
		if (outMetaModelItemProvider != null) outMetaModelItemProvider.dispose();
		if (ruleItemProvider != null) ruleItemProvider.dispose();
		if (sourceElementRuleItemProvider != null) sourceElementRuleItemProvider.dispose();
		if (targetElementRuleItemProvider != null) targetElementRuleItemProvider.dispose();
		if (elementIncludedItemProvider != null) elementIncludedItemProvider.dispose();
