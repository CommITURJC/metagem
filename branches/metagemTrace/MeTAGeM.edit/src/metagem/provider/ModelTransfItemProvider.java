...
/**
 * This is the item provider adapter for a {@link metagem.ModelTransf} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ModelTransfItemProvider
	 ...
	 * @generated
	 */
	public ModelTransfItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MetagemPackage.Literals.MODEL_TRANSF__ELEMENTS);
		}
	...
	public String getText(Object object) {
		String label = ((ModelTransf)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_ModelTransf_type") :
			getString("_UI_ModelTransf_type") + " " + label;
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MetagemPackage.Literals.MODEL_TRANSF__ELEMENTS,
