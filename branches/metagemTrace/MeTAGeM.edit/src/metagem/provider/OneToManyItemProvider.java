...
/**
 * This is the item provider adapter for a {@link metagem.OneToMany} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OneToManyItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MetagemPackage.Literals.ONE_TO_MANY__SOURCE);
			childrenFeatures.add(MetagemPackage.Literals.ONE_TO_MANY__TARGET);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MetagemPackage.Literals.ONE_TO_MANY__SOURCE,
				 MetagemFactory.eINSTANCE.createSourceElement()));

		newChildDescriptors.add
			(createChildParameter
				(MetagemPackage.Literals.ONE_TO_MANY__TARGET,
