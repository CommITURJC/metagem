...
/**
 * This is the item provider adapter for a {@link metagem.SourceElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SourceElementItemProvider
	extends RelationElementItemProvider
	implements
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SourceElement_invokes_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SourceElement_invokes_feature", "_UI_SourceElement_type"),
				 MetagemPackage.Literals.SOURCE_ELEMENT__INVOKES,
				 true,
				 false,
				 true,
				 null,
