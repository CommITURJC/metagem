...
public class ElementIncludedItemProvider extends ItemProviderAdapter implements
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ElementIncluded_typeAttribute_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ElementIncluded_typeAttribute_feature", "_UI_ElementIncluded_type"),
	...
	protected void addTypeElementPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ElementIncluded_typeElement_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ElementIncluded_typeElement_feature", "_UI_ElementIncluded_type"),
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MM_HybridPackage.Literals.ELEMENT_INCLUDED__RIGHT);
			childrenFeatures.add(MM_HybridPackage.Literals.ELEMENT_INCLUDED__LEFT);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ElementIncluded"));
	}
