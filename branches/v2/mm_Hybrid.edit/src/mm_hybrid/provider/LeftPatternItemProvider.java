...
public class LeftPatternItemProvider extends ItemProviderAdapter implements
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_LeftPattern_name_pattern_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_LeftPattern_name_pattern_feature", "_UI_LeftPattern_type"),
				 MM_HybridPackage.Literals.LEFT_PATTERN__NAME_PATTERN,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MM_HybridPackage.Literals.LEFT_PATTERN__TARGET_ELEMENT);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/LeftPattern"));
	}
