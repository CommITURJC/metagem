 ...
 *   <li>{@link RubyTL.impl.VariableImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class VariableImpl extends EObjectImpl implements Variable {
	...
	public EClassifier getType() {
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, RubyTLPackage.VARIABLE__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public void setType(EClassifier newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RubyTLPackage.VARIABLE__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RubyTLPackage.VARIABLE__NAME:
				return getName();
			case RubyTLPackage.VARIABLE__TYPE:
